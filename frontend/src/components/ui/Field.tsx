  ...
  return (
    <label className="block" htmlFor={inputId}>
      ...
      <input
        id={inputId}
        className={cx(
          'w-full rounded-lg border bg-eco-surface px-3.5 py-2.5 text-sm text-eco-ink placeholder:text-eco-ink3 focus:outline-none focus:ring-2 focus:ring-offset-1',
          error
