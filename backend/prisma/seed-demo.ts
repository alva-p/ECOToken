 ...
 * datos. Requisito: correr primero `npm run prisma:seed` y luego
 * `npm run prisma:seed:demo` una sola vez.
 *
...
async function main() {
  ...
  const coop2 = await prisma.empresa.upsert({
    ...
    create: {
      ...
      estado: 'APROBADA',
      activa: true,
      walletAddress: '0x222222222222222222222222222222222222222a',
    },
  });
  ...
  console.log('\n=== Seed de demo listo ===');
  console.log(
    'Empresa "hero" (historial largo):  empresa@ecotoken.test / empresa1234',
  );
  console.log(
    `  -> saldo esperado: ${saldoHero._sum.cantidad} ECO, 22 aportes en el historial`,
  );
  console.log(
    'Empresa 2 (aislamiento):            empresa2@ecotoken.test / empresa1234',
  );
  console.log(
    'Cooperativa 1:                      coop@ecotoken.test / coop1234',
  );
  console.log(
    'Cooperativa 2:                      coop2@ecotoken.test / coop1234',
  );
  console.log(
    'Admin:                              admin@ecotoken.test / admin1234',
  );
}
